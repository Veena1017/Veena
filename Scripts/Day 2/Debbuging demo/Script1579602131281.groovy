...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_LOGIN Panel_txtUsername'), 'admin123')

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_LOGIN Panel                                                      Username                                                                     Password'))
